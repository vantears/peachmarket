...
<body>
	...
	<form action="<c:url value='/saleboard/update'/>" method="post" enctype="multipart/form-data" onsubmit="getRidOfComma();">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="sb_name" placeholder="상품명을 입력해주세요." value="${board.sb_name }">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="price-holder">
				<input type="text" id="price-input" class="form-control price-input" name="sb_price" maxlength="11" placeholder="가격을 입력해주세요." value="${board.get_sb_price() }">
			</div>
		</div>
		<div class="form-group">
			<label>설명</label>
		...
		<div class="col text-center">
			<button class="btn btn-outline-success col-2">수정하기</button>
		</div>
	</form>
	</div>
